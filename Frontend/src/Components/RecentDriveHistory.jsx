...
const RecentDriveHistory = () => {
  const { captain } = useContext(CaptainDataContext)
  const name = captain?.captain?.fullname?.firstname || "Captain";
//   console.log("RecentDriveHistory", captain)
  ...
  return (
    <div className="w-full space-y-4 flex flex-col items-center justify-center">
      <h1 className="text-2xl font-bold text-gray-800 mt-2">👋 Welcome back, {name}!</h1>
...
export default RecentDriveHistory
